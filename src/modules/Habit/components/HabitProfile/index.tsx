...
import ProfileBtns from '../../UI/ProfileBtns';
         ...
         <div className={styles.info}>
            <div className={styles.category}>
               <svg className={styles.categoryIcon} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M11.0742 2.63299C11.3941 1.789 12.6051 1.789 12.9261 2.63299L14.996 8.3669C15.141 8.7469 15.51 8.99989 15.9219 8.99989H21.0087C21.9487 8.99989 22.3587 10.1699 21.6197 10.7429L17.9999 13.9998C17.8377 14.1245 17.7192 14.2973 17.6614 14.4935C17.6035 14.6896 17.6093 14.8991 17.6779 15.0918L18.9998 20.6947C19.3218 21.5947 18.2798 22.3677 17.4919 21.8137L12.5751 18.6937C12.4067 18.5754 12.2059 18.5119 12.0001 18.5119C11.7943 18.5119 11.5935 18.5754 11.4251 18.6937L6.50837 21.8137C5.7214 22.3677 4.67845 21.5937 5.00043 20.6947L6.32237 15.0918C6.39095 14.8991 6.39673 14.6896 6.33888 14.4935C6.28104 14.2973 6.16254 14.1245 6.00039 13.9998L2.38055 10.7429C1.64058 10.1699 2.05256 8.99989 2.99052 8.99989H8.0773C8.27758 9.00056 8.47334 8.9404 8.63869 8.82737C8.80403 8.71434 8.93116 8.55377 9.00325 8.3669L11.0732 2.63299H11.0742Z" stroke="#F68567" stroke-width="3.3" stroke-linecap="round" stroke-linejoin="round" />
               </svg>
               <span>Здоровье</span>
            </div>
            <h3 className={styles.title}>Выпивать стакан воды в день</h3>
            <p className={styles.start}><span>Начато:</span>  12.03.2023 13:12</p>
            <div className={styles.progress}>
               ...
               <span className={styles.progressText}>Прогресс: 11 из 30 (77%)</span>
            </div>
            <ProgressTrek />
            <button className={styles.btnCheck}>Сделать отметку</button>
            <p className={styles.lastCheck}><span>Последняя отметка:</span><br /> 12.03.2023 13:12</p>
         </div>
